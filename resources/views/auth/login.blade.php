...
<head>
  <!-- Title -->
  <title>Iniciar sesion | Meet and Sell</title>
      ...
      <div id="logoAndNav" class="container-fluid">
        ...
        <nav class="navbar navbar-expand u-header__navbar">
          ...
          <a class="d-none d-lg-flex navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-text-white" href="../home/index.html" aria-label="Front">
            ...
            <span class="u-header__navbar-brand-text">Meet and Sell</span>
          </a>
          <!-- End White Logo -->
          ...
          <a class="d-flex d-lg-none navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-collapsed" href="index.html" aria-label="Front">
            ...
            <span class="d-inline-block u-header__navbar-brand-text">Meet and Sell</span>
          </a>
          <!-- End Default Logo -->

          <!-- Button -->
          <div class="ml-auto">
          <a class="btn btn-sm btn-primary transition-3d-hover" href="{{url('/')}}">
              Inicio
            </a>
          </div>
          <!-- End Button -->
      ...
      <div class="col-lg-5 col-xl-4 d-none d-lg-flex align-items-center gradient-half-primary-v1 height-lg-100vh px-0">
        <div class="w-100 p-5">
          ...
          <div class="position-absolute right-0 bottom-0 left-0 text-center p-5">
            <h4 class="h6 text-white-70 mb-3">Socios de MeetAndSell</h4>
        ...
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <form class="js-validate mt-5" method="POST" action="{{ route('login') }}">
              ...
              <!-- Title -->
              <div class="mb-7">
                <h2 class="h3 text-primary font-weight-normal mb-0">Bienvenido <span class="font-weight-semi-bold">de nuevo</span></h2>
              ...
              <div class="js-form-message form-group">
                <label class="form-label" for="signinSrEmail">Correo electronico</label>
                <input type="email" class="form-control" name="email" id="signinSrEmail" placeholder="Correo electronico" aria-label="Correo electronico" required
                       data-msg="Por favor ingresa una direccion de correo valido."
              ...
              <div class="js-form-message form-group">
                <label class="form-label" for="signinSrPassword">
                  <span class="d-flex justify-content-between align-items-center">
                    Contraseña
                    <a class="link-muted text-capitalize font-weight-normal" href="{{ route('password.request') }}">¿Olvidaste tu contraseña?</a>
                  </span>
                </label>
                <input type="password" class="form-control" name="password" id="signinSrPassword" placeholder="********" aria-label="********" required
                       data-msg="Tu contraseña es invalida. Intentalo de nuevo."
                       data-error-class="u-has-error"
                       data-success-class="u-has-success">
              </div>
              <!-- End Form Group -->
              ...
              <div class="row align-items-center mb-5 offset-6">
              ...
              <div class="row align-items-center mb-5 offset-3" style="margin-top: -30px">
