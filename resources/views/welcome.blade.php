...
<head>
  <!-- Title -->
  <title>Inicio | Meet and Sell</title>
          ...
          <div class="ml-auto">
            ...
            <div class="d-inline-block d-sm-none position-relative mr-2">
              ...
              <div id="jumpToDropdown" class="dropdown-menu dropdown-unfold" aria-labelledby="jumpToDropdownInvoker">
                ...
                <a class="dropdown-item" href="{{url('/contacto')}}">Contactanos</a>
              </div>
            </div>
            <!-- End Jump To -->
            ...
            <div class="d-none d-sm-inline-block ml-sm-auto">
              <ul class="list-inline mb-0">
                <li class="list-inline-item mr-0">
                  <a class="u-header__navbar-link" href="{{url('/ayuda')}}">Ayuda</a>
                </li>
                <li class="list-inline-item mr-0">
                  <a class="u-header__navbar-link" href="{{url('/contacto')}}">Contactanos</a>
                </li>
              </ul>
            </div>
            <!-- End Links -->
      ...
      <div id="logoAndNav" class="container">
        ...
        <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space">
          ...
          <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="index.html" aria-label="Front">
            ...
            <span class="u-header__navbar-brand-text">MAS</span>
          </a>
          <!-- End Logo -->
          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-mega-menu u-header__nav-item">
                <a id="homeMegaMenu" class="nav-link u-header__nav-link " href="#" >Inicio</a>
              ...
              <li class="nav-item hs-has-mega-menu u-header__nav-item">
                <a id="blogMenu" class="nav-link u-header__nav-link " href="#" >Blog</a>
              </li>
              <!--End Blog-->

              <!--About-->
              <li class="nav-item hs-has-mega-menu u-header__nav-item">
                <a id="blogMenu" class="nav-link u-header__nav-link " href="#" >Sobre Nosotros</a>
              </li>
              <!--End About-->
              ...
              <a class="btn btn-sm btn-primary transition-3d-hover" href="{{url('/login')}}">
  ...
  <main id="content" role="main">
    ...
    <div class="d-lg-flex position-relative">
      <div class="container d-lg-flex align-items-lg-center space-top-2 space-top-md-5 space-lg-0 min-height-lg-100vh">
        ...
        <div class="row w-100">
          <div class="col-lg-5">
            <h1 class="display-4 font-size-md-down-5 mb-3">Introducción a Meet and Sell</h1>
            <p>
              Tu compañia lucirá 
              ...
              <br>
              Te conectamos con la gente para continuar tu gran empresa
            </p>

            <div class="d-flex align-items-center flex-wrap">
              <a class="btn btn-soft-primary btn-wide transition-3d-hover" href="../pages/login-simple.html">Empezar</a>
  ...
  <footer>
      ...
      <div class="container space-2">
        <div class="row justify-content-md-between">
          <div class="col-sm-4 col-lg-2 mb-4 mb-lg-0">
            <h4 class="h6 font-weight-semi-bold">Acerca</h4>

            <!-- List Group -->
            <ul class="list-group list-group-flush list-group-borderless mb-0">
            <li><a class="list-group-item list-group-item-action" href="{{url('/acerca')}}">Acerca</a></li>
              <li><a class="list-group-item list-group-item-action" href="{{url('/servicios')}}">Servicios</a></li>
              <li><a class="list-group-item list-group-item-action" href="{{url('/empleo')}}">Empleo</a></li>
            </ul>
            <!-- End List Group -->
          </div>

          <div class="col-sm-4 col-lg-2 mb-4 mb-lg-0">
            <h4 class="h6 font-weight-semi-bold">Cuenta</h4>

            <!-- List Group -->
            <ul class="list-group list-group-flush list-group-borderless mb-0">
              <li><a class="list-group-item list-group-item-action" href="{{url('/account')}}">Cuenta</a></li>
          ...
          <div class="col-sm-4 col-lg-2 mb-4 mb-lg-0">
            ...
            <!-- List Group -->
            <ul class="list-group list-group-flush list-group-borderless mb-0">
              <li><a class="list-group-item list-group-item-action" href="{{url('/ayuda')}}">Ayuda</a></li>
              <li><a class="list-group-item list-group-item-action" href="{{url('/terminos')}}">Terminos</a></li>
              <li><a class="list-group-item list-group-item-action" href="{{url('/privacidad')}}">Privacidad</a></li>
            </ul>
            <!-- End List Group -->
          </div>

          <div class="col-md-6 col-lg-4">
            <h4 class="h6 font-weight-semi-bold mb-4">Estamos impulsados a entregar resultados para todos sus negocios.</h4>
            ...
            <button type="button" class="btn btn-xs btn-dark btn-wide transition-3d-hover text-left mb-2 mr-1">
              <span class="media align-items-center">
                ...
                <span class="media-body">
                  <span class="d-block">Descargar en la</span>
            ...
            <button type="button" class="btn btn-xs btn-dark btn-wide transition-3d-hover text-left mb-2">
              <span class="media align-items-center">
                ...
                <span class="media-body">
                  <span class="d-block">Consiguela en </span>
    ...
    <div class="container text-center space-1">
      ...
      <a class="d-inline-flex align-items-center mb-2" href="index.html" aria-label="Front">
        ...
        <span class="brand brand-primary">Meet and Sell</span>
      </a>
      <!-- End Logo -->
      <p class="small text-muted">&copy; MeetAndSell. 2018 Meet and Sell. All rights reserved.</p>
    </div>
    <!-- End Copyright -->
  </footer>
  <!-- ========== END FOOTER ========== -->
  ...
  <script>
    ...
    $(document).on('ready', function () {
      ...
      var typed = new Typed(".u-text-animation.u-text-animation--typing", {
        strings: ["más profesional.", "perfecta en todo sentido.", "asombrosa."],
        typeSpeed: 60,
        loop: true,
        backSpeed: 25,
        backDelay: 1500
